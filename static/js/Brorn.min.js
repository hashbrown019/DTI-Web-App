...
function http(p){
	...
	this.xhttp.onerror = function(){
		println(" $HTTP Gone Wrong Error : "+e)
		println(params)
		println(" $HTTP Error End -------- ")
	}
